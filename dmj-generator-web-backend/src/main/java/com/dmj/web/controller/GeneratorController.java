...
import com.dmj.maker.generator.main.GeneratorTemplate;
import com.dmj.maker.generator.main.ZipGenerator;
import com.dmj.maker.meta.MetaValidator;
...
import com.dmj.web.manager.CosManager;
import com.dmj.maker.meta.Meta;
import com.dmj.web.model.dto.generator.*;
...
public class GeneratorController {
     ...
     * @param response
     */
    @GetMapping("/downloadGeneratorById")
...
//                .orElseThrow(RuntimeException::new);
        ...
        try {
            ...
            e.printStackTrace();
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "执行下载文件错误");
        } finally {
    ...
    public void makeGenerator(@RequestBody GeneratorMakeRequest generatorMakeRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        MetaValidator.doValidAndFillDetail(meta);
        String outputPath = String.format("%s/generated/%s", tempDirPath, meta.getName());

        // 5）调用 maker 方法制作生成器
        GeneratorTemplate generateTemplate = new ZipGenerator();
        try {
