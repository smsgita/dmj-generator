...
/** downloadGeneratorById GET /api/generator/downloadGeneratorById */
export async function downloadGeneratorByIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.downloadGeneratorByIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<any>('/api/generator/downloadGeneratorById', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** searchGeneratorVOByPage POST /api/generator/search/page/vo */
export async function searchGeneratorVoByPageUsingPost(
  body: API.GeneratorQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageGeneratorVO_>('/api/generator/search/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
